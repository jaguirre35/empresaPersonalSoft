...
public class RegistrarseActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ocultar barra, asociar objetos, iniciar la cola de consultas
    ...
    public void Consultar(View view){
        ...
        if(usuario.isEmpty()) {
            ...
            url = "http://172.16.63.7/WebServices/consulta.php?usr=" + usuario;
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            jsonObject = jsonArray.getJSONObject(0);//posicion 0 del arregloh....
